...
Monolith, one binary, layered into small modules the agent can grow independently:
...
stay static and small. Measure binary size and note regressions in the scan journal.
...
The live, authoritative task order lives in [`../PROGRESS.md`](../PROGRESS.md).
